...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        # result_path = "E:\\progectlocation\\05.haixin_U-tube\\02.python\\images_cut_Yolo\\result\\"
        # img_path = "E:/progectlocation/05.haixin_U-tube/02.python/images_cut_Yolo/dataset/71.jpg"
        # weights = "E:/progectlocation/05.haixin_U-tube/02.python/images_cut_Yolo/checkpoints/circle_yolo_5s_1024_20220213.pt"
        weights = sys.argv[1]
        img_path = sys.argv[2]
        ...
        for coordinate in int_boxes:
            ...
            img_save_path = result_path + "\\" + str(i) + ".jpg"
            print(img_save_path)
